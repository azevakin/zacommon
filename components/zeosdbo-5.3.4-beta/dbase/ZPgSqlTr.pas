...
type
  ...
  public
    ...
    procedure Reset;
    function ExecSql(Sql: WideString; comp: TComponent): LongInt; override;
...
function TZPgSqlTransact.ExecSql(Sql: WideString; comp : TComponent): LongInt;
begin
  TDirPgSqlTransact(Handle).Notice := '';
  Result := inherited ExecSql(Sql, comp);
...
begin
  inherited Connect;
//  ExecSql('SET DateStyle TO ''German''', self);
end;
