  ...
  repeat
    ...
    begin
      ...
      while (N <= Length(Buffer)) do
         begin
         //Code changed by PFAF on 22/02/2002 to work with TZQuery ' SELECT "xxx", "yyy", "zzz" FROM "MyTable" '
         //Since we are defining a field using '''' and '"' characters
         //the parenthesis characters '(' and ')' should
         //be treated as simple characters, and should be ignored
         if (Buffer[N] = Quote) then break;
         Inc(N);
         end;
