...
// (DO NOT EDIT: machine generated header) 'FR_DBXMd.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TfrDBXFieldsLinkForm;
class PASCALIMPLEMENTATION TfrDBXFieldsLinkForm : public Forms::TForm 
{
...
public:
	...
	Sqlexpr::TSQLTable* DetailDS;
public:
	#pragma option push -w-inl
	/* TCustomForm.Create */ inline __fastcall virtual TfrDBXFieldsLinkForm(Classes::TComponent* AOwner) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrDBXFieldsLinkForm(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrDBXFieldsLinkForm(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TfrDBXFieldsLinkForm(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
