...
// (DO NOT EDIT: machine generated header) 'FR_BDEMd.pas' rev: 5.00
...
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TfrBDEFieldsLinkForm;
class PASCALIMPLEMENTATION TfrBDEFieldsLinkForm : public Forms::TForm 
{
...
public:
	...
	Dbtables::TTable* DetailDS;
public:
	#pragma option push -w-inl
	/* TCustomForm.Create */ inline __fastcall virtual TfrBDEFieldsLinkForm(Classes::TComponent* AOwner
		) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrBDEFieldsLinkForm(Classes::TComponent* AOwner
		, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrBDEFieldsLinkForm(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TfrBDEFieldsLinkForm(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
