...
READ THIS FILE ACCURATELY BEFORE INSTALLING FR2.5!
...
get latest information. 
   ...
   FastReport 2.5 is "try before buy". See "Ordering" topic for details.
...
3.1. Run fr250.exe and follow to instructions of installation program
...
----------------------------------------------------------------------------
4. BACKWARD COMPATIBILITY
   .frf files from FR2.1...FR2.5 is compatible. You can use FR2.1 .frf
...
----------------------------------------------------------------------------
6. ORDERING
   FastReport 2.5 is "try before buy". You can try trial version of 
FastReport2.5, which prints only one page of report with nag label 
"FastReport - unregistered". Full version of FR shipped with full source code.
   Single copy of FR2.5 costs $99. Site license (unlimited number of copies)
...
to buy it even if you already registered FR 2.5).
